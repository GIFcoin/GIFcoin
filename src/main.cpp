...
uint256 hashGenesisBlock("0x3bba5278430154aa08cd90059dbcd557a8ba43865449ab7bad86dd8b3bdbc9fa");
...
const string strMessageMagic = "GIFcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // GIFcoin: 0.35 days
static const int64 nTargetSpacing = 15; // GIFcoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal gifcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GIFcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// Genesis block:
	// block.nTime = 1367712618 
	// block.nNonce = 2322146 
	...
	//  nTime=1367712618, nBits=1e0ffff0, nNonce=2085386442, vtx=1)
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "New York Times 4 May 2013 Israel Targeted Iranian Missiles in Syrian Attack";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x1eada512ed57fd6be67321416c09e3979f93ebf586ec904d55d578ffa133924f"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // increase each by adding 2 to gifcoin's value.
